...
Both thresholds were selected on a local harness built around the official evaluation code over
training cases, and confirmed on the official validation set. All code, the exact decode, the container definition and the
