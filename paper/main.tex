...
% ---- annotations -----------------------------------------------------------
\node[font=\scriptsize,align=center,anchor=north,green!35!black] at (2.02,-0.135)
  {\textbf{kept}\\[-1pt] peak $0.92>t_{\mathrm{hi}}$};
\node[font=\scriptsize,align=center,anchor=north,red!55!black] at (5.51,-0.135)
  {\textbf{discarded}\\[-1pt] peak $0.52<t_{\mathrm{hi}}$};
\node[font=\scriptsize,align=center,anchor=north,green!35!black] at (8.45,-0.135)
  {\textbf{kept}\\[-1pt] peak $0.88>t_{\mathrm{hi}}$\\[-1pt] (only 30 voxels)};
...
(green), and drops those that never do (red). All three are decided by peak alone; size is never
consulted, so the 30-voxel lesion survives while the far larger diffuse region, which never
reaches $t_{\mathrm{hi}}$ anywhere, does not.}
\label{fig:hyst}
\end{figure}
